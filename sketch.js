...
function draw() {
 background(0);
   balaovermeio.collide(flecha);
   balaorosa.collide(flecha);
   balaoazul.collide(flecha);
   balaoverde.collide(flecha);
...
//pontos
  ...
  //Colisão
  if (balaovermeio.collide (flecha)){
    //balaovermeio.DestroyEach();
    score = score +1;
